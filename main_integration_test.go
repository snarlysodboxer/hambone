...
func TestApplyInstance(t *testing.T) {
	connection, instancesClient, tempDir := setupForGit()
	...
	returnedInstance, err := instancesClient.Apply(context.Background(), instance)
	if err != nil {
		t.Fatal(err)
	}
	...
	// clean up
	_, err = instancesClient.Delete(context.Background(), instance)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestUpdateInstance(t *testing.T) {
	...
	_, err := instancesClient.Apply(context.Background(), oldInstance)
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = instancesClient.Apply(context.Background(), instance)
	if err != nil {
	...
	_, err = instancesClient.Apply(context.Background(), newInstance)
	if err != nil {
...
func TestDeleteInstance(t *testing.T) {
	...
	returnedInstance, err := instancesClient.Delete(context.Background(), instance)
	if err != nil {
		t.Fatal(err)
	}
	sentVSReturned(t, returnedInstance, instance)
...
func TestGetInstance(t *testing.T) {
	...
	_, err := instancesClient.Apply(context.Background(), instance1)
	if err != nil {
		t.Fatal(err)
	}
	name = "my-client-345"
	...
	_, err = instancesClient.Apply(context.Background(), instance3)
	if err != nil {
		t.Fatal(err)
	}
	name = "my-client-456"
	...
	_, err = instancesClient.Apply(context.Background(), instance4)
	if err != nil {
		t.Fatal(err)
	}
	...
	instanceList, err := instancesClient.Get(context.Background(), getOptions)
	if err != nil {
		t.Fatal(err)
	}
