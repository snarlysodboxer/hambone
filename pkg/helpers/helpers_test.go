...
func TestConvertStartStopToSliceIndexs(t *testing.T) {
	...
	indexStart, indexStop := helpers.ConvertStartStopToSliceIndexes(1, 10, int32(len(slice)))
	...
	indexStart, indexStop = helpers.ConvertStartStopToSliceIndexes(0, 10, int32(len(slice)))
	expectStart, expectStop = int32(0), int32(10)
	if indexStart != expectStart || indexStop != expectStop {
		t.Errorf("Expected: %d, %d, got: %d, %d", expectStart, expectStop, indexStart, indexStop)
	}
	...
	indexStart, indexStop = helpers.ConvertStartStopToSliceIndexes(1, 30, int32(len(slice)))
	...
	indexStart, indexStop = helpers.ConvertStartStopToSliceIndexes(1, 0, int32(len(slice)))
	expectStart, expectStop = int32(0), int32(0)
	if indexStart != expectStart || indexStop != expectStop {
		t.Errorf("Expected: %d, %d, got: %d, %d", expectStart, expectStop, indexStart, indexStop)
	}
	indexStart, indexStop = helpers.ConvertStartStopToSliceIndexes(0, 0, int32(len(slice)))
	if indexStart != expectStart || indexStop != expectStop {
		t.Errorf("Expected: %d, %d, got: %d, %d", expectStart, expectStop, indexStart, indexStop)
	}
}
